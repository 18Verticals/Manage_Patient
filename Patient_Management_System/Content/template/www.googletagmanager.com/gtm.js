...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "macros": [{
                ...
                "vtp_trackingId": "UA-103271654-39",
            ...
            "tags": [{
                ...
                "vtp_eventCategory": "Book An Appointment CTA",
                "vtp_trackType": "TRACK_EVENT",
                "vtp_gaSettings": ["macro", 2],
                "vtp_eventAction": "Click",
                "vtp_eventLabel": "Book An Appointment",
                "vtp_enableRecaptchaOption": false,
                "vtp_enableUaRlsa": false,
                "vtp_enableUseInternalVersion": false,
                ...
                "vtp_nonInteraction": false,
                "vtp_overrideGaSettings": false,
                "vtp_eventCategory": "Submit CTA",
                "vtp_trackType": "TRACK_EVENT",
                "vtp_gaSettings": ["macro", 2],
                "vtp_eventAction": "Click",
                "vtp_eventLabel": "Submit CTA Click",
                "vtp_enableRecaptchaOption": false,
                "vtp_enableUaRlsa": false,
                "vtp_enableUseInternalVersion": false,
                "vtp_enableFirebaseCampaignData": true,
                ...
                "vtp_conversionId": "10821310478",
                "vtp_conversionLabel": "yYOsCJXku4oDEI6wgKgo",
                "vtp_rdp": false,
                "vtp_url": ["macro", 4],
    ...
    */
    ...
    Ii.Je = Number("0") || 0;
    Ii.rb = "dataLayer";
    Ii.Hn = "ChEIgMnOuwYQjMXexp+m5qDFARIkAGzn9gNWtbvZB1vdX/fqMCYKp3ZKfA3g1v9l1PmYfxEJ8N7lGgITmg\x3d\x3d";
    var Ki = {
            __cl: 1,
            __ecl: 1,
            __ehl: 1,
    ...
    var ml;
    try {
        ml = JSON.parse(Ta("eyIwIjoiSU4iLCIxIjoiSU4tR0oiLCIyIjpmYWxzZSwiMyI6Imdvb2dsZS5jby5pbiIsIjQiOiIiLCI1Ijp0cnVlLCI2IjpmYWxzZSwiNyI6ImFkX3N0b3JhZ2V8YW5hbHl0aWNzX3N0b3JhZ2V8YWRfdXNlcl9kYXRhfGFkX3BlcnNvbmFsaXphdGlvbiJ9"))
    } catch (a) {
        T(123), ll(2), ml = {}
    }
    ...
    var XE = function(a, b) {
            if (!b.isGtmEvent) {
                ...
                if (e === void 0) {
                    ...
                    f === 1 && (f = WE(c));
                    z(f) ? Px()(function() {
                        var g, k, m, n = (m = (g = Px()) == null ? void 0 : (k = g.getByName) == null ? void 0 : k.call(g, a)) == null ? void 0 : m.get(f);
                        d(n)
                    }) : d(void 0)
                } else d(e)
            }
                ...
                var d = !V(N.g.U),
                    e = function(f) {
                        ...
                        if (c.isGtmEvent || aF(b, n.createOnlyFields)) {
                            ...
                            d && V(N.g.U) && (d = !1, m(function() {
                                var u, v, t = (u = Px()) == null ? void 0 : (v = u.getByName) == null ? void 0 : v.call(u, c.isGtmEvent ? g : b);
                                !t || t.get("clientId") == p && q || (c.isGtmEvent ? (n.fieldsToSet["&gcu"] = "1", n.fieldsToSet["&sst.gcut"] = th[f]) : (n.fieldsToSend["&gcu"] = "1", n.fieldsToSend["&sst.gcut"] = th[f]), t.set(n.fieldsToSet),
        ...
        lF = function(a, b, c) {
            ...
            function e(M) {
                ...
                if (da) {
                    ...
                    Q !== "promo_view" && Q !== "impressions" && (Z("ec:addProduct", da.Sc), d("ec:setAction",
                        Q, da.Cb))
                }
            }
            ...
            function f(M) {
                if (M) {
                    var Z = {};
                    if (Qc(M))
                        for (var ca in fF) fF.hasOwnProperty(ca) && gF(fF[ca], ca, M[ca], Z);
                    cF(Z, y);
                    d("require", "linkid", Z)
                }
            }
                ...
                r(function() {
                    if (!c.isGtmEvent && Qc(M)) {
                        var Z = t.fieldsToSend,
                            ca, da, Y = (ca = u()) == null ? void 0 : (da = ca.getByName) == null ? void 0 : da.call(ca, v),
                            Q;
                        for (Q in M)
                            if (M[Q] !=
                                null && /^(dimension|metric)\d+$/.test(Q)) {
                                var oa = void 0,
            ...
            var p = a,
                q, r = c.isGtmEvent ? Sx(U(c, "gaFunctionName")) : Sx();
            if (Za(r)) {
                var u = Px,
                    v;
                c.isGtmEvent ? v = U(c, "name") || U(c, "gtmTrackerName") : v = "gtag_" + p.split("-").join("_");
                var t = $E(v, b, c);
                !c.isGtmEvent && aF(v, t.createOnlyFields) &&
                    (r(function() {
                        var M, Z;
                        u() && ((M = u()) == null || (Z = M.remove) == null || Z.call(M, v))
                    }), iF[v] = !1);
        ...
        eF = function(a, b) {
            ...
            if (Qc(k))
                for (var m = 0; e && m < e.length; ++m) {
                    var n = e[m],
                        p;
                    for (p in k) k.hasOwnProperty(p) && /^(dimension|metric)\d+$/.test(p) && k[p] != null && hF(n, p, n[k[p]])
                }
            var q = null,
                r = d(N.g.nj);
            if (a === N.g.Ka || a === N.g.Cc) q = {
                action: a,
                Cb: c(),
                Sc: oF(e)
            };
            ...
            else if (a === "select_content" && r && r.length > 0 || a === N.g.Lb) q = {
                action: "promo_click",
                tf: oF(r) || oF(e)
            };
            else if (a === "select_content" || a === N.g.Bc) q = {
                action: "click",
                Cb: {
            ...
            function b(e) {
                ...
                (function() {
                    if (e.category) g.category = e.category;
                        ...
                        for (var k = "", m = 0; m < pF.length; m++) e[pF[m]] !== void 0 && (k &&
                            (k += "/"), k += e[pF[m]]);
                        k && (g.category = k)
                    }
                })();
        ...
        $E = function(a, b, c) {
            ...
            for (var r = !c.isGtmEvent, u = om(c), v = 0; v < u.length; ++v) {
                ...
                if (c.isGtmEvent) {
                    ...
                    if (uF.hasOwnProperty(t)) gF(uF[t], t, x, e);
                    ...
                    else if (VE.hasOwnProperty(t)) gF(VE[t],
                        t, x, f);
                    else if (UE.hasOwnProperty(t)) gF(UE[t], t, x, k);
                    else if (/^(dimension|metric|content_group)\d+$/.test(t)) gF(1, t, x, f);
                    else if (t === N.g.fa) {
                        if (!wF) {
                            var y = xb(x);
                            y && (f["&did"] = y)
                        ...
                        B && (f["&gdid"] = B);
                        C && (f["&edid"] = C)
                    } else t === N.g.La && u.indexOf(N.g.Dc) < 0 && (k.cookieName = String(x) + "_ga");
                    R(135) && xF[t] && (c.H.hasOwnProperty(t) || b === N.g.ba && c.j.hasOwnProperty(t)) && (r = !1)
                }
            }
            R(135) && r && (f["&jsscut"] = "1");
            d(N.g.Ef) !== !1 &&
                d(N.g.hb) !== !1 && TE() || (g.allowAdFeatures = !1);
            ...
            if (c.isGtmEvent) {
                ...
                b === "login" || b === "sign_up" || b === "share" ? hF(e, "eventLabel", d(N.g.fh)) : b === "search" || b === "view_search_results" ? hF(e, "eventLabel", d(N.g.Dj)) : b === "select_content" &&
                    hF(e, "eventLabel", d(N.g.jj));
                var H = e[N.g.za] || {},
                    J = H[N.g.Kc];
            ...
            Ao() && (g["&gcs"] = Bo());
            g["&gcd"] = Fo(c);
            bl() && (V(N.g.U) || (k.storage = "none"), V([N.g.N, N.g.O]) || (g.allowAdFeatures = !1, k.storeGac = !1));
            Io() && (g["&dma_cps"] = Go());
            g["&dma"] = Ho();
            Wn(eo()) && (g["&tcfd"] = Jo());
            dj() && (g["&tag_exp"] = dj());
        ...
        gF = function(a, b, c, d) {
            if (c !== void 0)
                if (CF[b] && (c = ib(c)), b !== "anonymize_ip" || c || (c = void 0), a === 1) d[WE(b)] = c;
                else if (z(a)) d[a] = c;
            else
    ...
    var kF = !1,
        ...
        ZE = {},
        DF = {},
        xF = (DF[N.g.na] = 1, DF[N.g.hb] = 1, DF[N.g.Qa] = 1, DF[N.g.Ra] = 1, DF[N.g.cb] = 1, DF[N.g.Dc] = 1, DF[N.g.xb] = 1, DF[N.g.La] = 1, DF[N.g.ic] = 1,
            DF[N.g.hh] = 1, DF[N.g.ra] = 1, DF[N.g.wd] = 1, DF[N.g.Ea] = 1, DF[N.g.eb] = 1, DF),
        EF = {},
        ...
        FF = {},
        tF = (FF._cs = 1, FF._useUp = 1, FF.allowAnchor = 1, FF.allowLinker = 1, FF.alwaysSendReferrer = 1, FF.clientId = 1, FF.cookieDomain = 1, FF.cookieExpires = 1, FF.cookieFlags = 1, FF.cookieName = 1, FF.cookiePath = 1, FF.cookieUpdate =
            1, FF.legacyCookieDomain = 1, FF.legacyHistoryImport = 1, FF.name = 1, FF.sampleRate = 1, FF.siteSpeedSampleRate = 1, FF.storage = 1, FF.storeGac = 1, FF.useAmpClientId = 1, FF._cd2l = 1, FF),
        vF = {
            anonymize_ip: 1
        },
        GF = {},
        VE = (GF.campaign = {
            ...
            "transport", GF[N.g.Aa] = "currencyCode", GF[N.g.gh] = 1, GF[N.g.ra] = "location", GF[N.g.wd] = "page", GF[N.g.Ea] = "referrer", GF[N.g.eb] = "title", GF[N.g.Rf] = 1, GF[N.g.Ca] = 1, GF),
        HF = {},
        ...
        KF = {},
        jF = (KF.checkout_progress = 1, KF.select_content = 1, KF.set_checkout_option = 1, KF[N.g.zc] = 1, KF[N.g.Ac] = 1, KF[N.g.ac] = 1, KF[N.g.Bc] = 1, KF[N.g.sb] = 1, KF[N.g.Lb] = 1, KF[N.g.tb] =
            1, KF[N.g.Ka] = 1, KF[N.g.Cc] = 1, KF[N.g.Pa] = 1, KF),
        LF = {},
    ...
    X.securityGroups.ua = ["google"],
        function() {
            ...
            function b(n) {
                var p = {};
                n.vtp_gaSettings && GK(JK(n.vtp_gaSettings.vtp_fieldsToSet, "fieldName", "value"), p);
            ...
            function d(n, p, q) {
                var r = function(M, Z, ca) {
                    ...
                    v = {},
                    t = (v[N.g.Bc] = "click", v[N.g.Pa] = "detail", v[N.g.zc] = "add", v[N.g.Ac] = "remove", v[N.g.ac] = "checkout", v[N.g.Ka] = "purchase", v[N.g.Cc] = "refund", v),
                    w;
                ...
                if (n.vtp_useGA4SchemaForEcommerce) {
                    if (q === N.g.sb && !w.impressions) w.items && (y.impressions = w.items, y.translateIfKeyEquals = "impressions");
                    else if (q === N.g.tb && !w.promoView) w.promoView = {}, w.items && (y.promoView = {}, y.promoView.promotions = w.items, y.translateIfKeyEquals = "promoView");
                    else if (q === N.g.Lb && !w.promoClick) w.promoClick = {}, w.items && (y.promoClick = {}, y.promoClick.promotions = w.items, y.translateIfKeyEquals =
                ...
                for (var J = "detail checkout checkout_option click add remove purchase refund".split(" "), F = 0; F < J.length; F++) {
                    var S = w[J[F]];
            ...
            function e(n, p) {
                if (!f && (!fj() && !Ri || !p._x_19 || n.vtp_useDebugVersion || n.vtp_useInternalVersion)) {
                    ...
                    var r = n.vtp_gtmOnFailure,
                        ...
                        v = us("https:", "http:", "//www.google-analytics.com/" + q, p && !!p.forceSSL);
                    UK(q === "analytics.js" && u ? u : v, function() {
                        var t = Px();
                        t && t.loaded ||
                            r();
                    }, r)
            ...
            var f, g = {
                ...
                m = function(n) {
                    ...
                    n.vtp_setTrackerName &&
                        typeof n.vtp_trackerName == "string" ? n.vtp_trackerName !== "" && (C = n.vtp_trackerName, B = C + ".") : (C = "gtm" + $i(), B = C + ".");
                    ...
                    if (n.vtp_trackType === "TRACK_EVENT") y = "track_event", p(), w.eventCategory = String(n.vtp_eventCategory), w.eventAction = String(n.vtp_eventAction), w.eventLabel = c(String, n.vtp_eventLabel),
                        ...
                        if (y = N.g.bc, p(), n.vtp_advertisingFeaturesType == "DISPLAY_FEATURES_WITH_REMARKETING_LISTS" && (w.remarketingLists = !0), n.vtp_autoLinkDomains) {
                            var H = {};
                        ...
                        n.vtp_trackType == "TRACK_TIMING" && (y = "timing_complete", w.eventCategory = String(n.vtp_timingCategory), w.timingVar = String(n.vtp_timingVar), w.value = hb(n.vtp_timingValue), w.eventLabel = c(String, n.vtp_timingLabel));
                    ...
                    var F = Cm(Bm(Am(zm(sm(new rm(n.vtp_gtmEventId, n.vtp_gtmPriorityId),
    ...
    X.securityGroups.gas = ["google"], X.__gas = function(a) {
        ...
        return b
    }, X.__gas.o = "gas", X.__gas.isVendorTemplate = !0, X.__gas.priorityOverride = 0, X.__gas.isInfrastructure = !1, X.__gas.runInSiloedMode = !1;
