google.maps.__gjsload__('search', function(_) {
    var Jua = function() {},
        ...
        Lua = function(a) {
            ...
            const d = [];
            a.Lu().forEach(e => {
                e.a && e.a.length >= 2 && d.push(new Kua(e, b, c))
            });
            return d
        },
        Mua = function(a) {
    ...
    var Nua = {
        ...
        Kua = class {
            ...
            getAnchor() {
                if (!this.anchor) {
                    const a = 1 << this.zoom;
                    this.anchor = _.ym(new _.Km((this.nn.x * 256 + this.source.a[0]) / a, (this.nn.y * 256 + this.source.a[1]) / a)).toJSON()
                }
                return this.anchor
            }
            getCompleteBounds() {
    ...
    eB.prototype.changed = function() {
        ...
        _.zj("search_impl").then(d => {
            d.BG(a);
            c && (d = c.get("blockingLayerCount") || 0, c.set("blockingLayerCount", d - 1))
        })
    };
    eB.enableFeatureMapEventsRasterOnly = function(a) {
        if (_.pn[15]) {
            var b = a.__gm.Wg;
            if (!Oua.has(a)) {
                Oua.add(a);
                var c = [],
                    ...
                    e = () => {
                        ...
                        b.forEach(f => {
                            if (f = f.data) c.push(_.Ik(f, "insert", g => d(g, "addfeatures"))), c.push(_.Ik(f, "remove", g => d(g, "removefeatures")))
                        })
                    };
                ...
                f.length && _.Uk(a, "addfeatures", f)
            })()
        }
    };
    _.Ha("module$contents$mapsapi$onionLayers$search$googleLayer_GoogleLayer.enableFeatureMapEventsRasterOnly", eB.enableFeatureMapEventsRasterOnly);
    _.Al(eB.prototype, {
        map: _.rp
    });
